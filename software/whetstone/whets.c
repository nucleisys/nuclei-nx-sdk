 ...
 * ~/toolchain/raspbian-toolchain-gcc-4.7.2-linux32/bin/arm-linux-gnueabihf-gcc  whets.c cpuidc.c -lm -lrt -O3 -march=armv6 -mfloat-abi=hard -mfpu=vfp -o whetstonePiA6
 *
 * Compile on Raspberry Pi
 * gcc  whets.c cpuidc.c -lm -lrt -O3 -march=armv6 -mfloat-abi=hard -mfpu=vfp -o whetstonePiA6
 *
 *************************************************************************
 *
 *  Document:         Whets.c
...
#if __riscv_flen == 64
# define SAVE_FPU_REG		
# define RESTORE_FPU_REG			
# define PFOLAT		 double
#else
# define SAVE_FPU_REG		SAVE_FPU_REG_F
# define RESTORE_FPU_REG			RESTORE_FPU_REG_F
# define PFOLAT		   float
#endif
